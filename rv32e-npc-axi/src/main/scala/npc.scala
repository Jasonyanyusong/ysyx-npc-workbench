...
class NPC extends Module{
    ...
    // Connect with top signals: W
    NPC_LSU.LSU_AXI_W.iMasterWready := NPC_AXI_W.iMasterWready
    NPC_AXI_W.oMasterWvalid := NPC_LSU.LSU_AXI_W.oMasterWvalid
    NPC_AXI_W.oMasterWdata := NPC_LSU.LSU_AXI_W.oMasterWdata
    ...
    // Connect with top signals: AR
    Arbiter.out_ar_b.iMasterARready := NPC_AXI_AR.iMasterARready
    NPC_AXI_AR.oMasterARvalid := Arbiter.out_ar_b.oMasterARvalid
    NPC_AXI_AR.oMasterARaddr := Arbiter.out_ar_b.oMasterARaddr
    NPC_AXI_AR.oMasterARid := Arbiter.out_ar_b.oMasterARid
    NPC_AXI_AR.oMasterARlen := Arbiter.out_ar_b.oMasterARlen
    NPC_AXI_AR.oMasterARsize := Arbiter.out_ar_b.oMasterARsize
    NPC_AXI_AR.oMasterARburst := Arbiter.out_ar_b.oMasterARburst

    // Connect with top signals: R
    NPC_AXI_R.oMasterRready := Arbiter.out_r_b.oMasterRready
    Arbiter.out_r_b.iMasterRvalid := NPC_AXI_R.iMasterRvalid
    Arbiter.out_r_b.iMasterRresp := NPC_AXI_R.iMasterRresp
    Arbiter.out_r_b.iMasterRdata := NPC_AXI_R.iMasterRdata
    Arbiter.out_r_b.iMasterRlast := NPC_AXI_R.iMasterRlast
    Arbiter.out_r_b.iMasterRid := NPC_AXI_R.iMasterRid
