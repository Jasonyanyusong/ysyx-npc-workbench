...
object rv64_bitpat{
    ...
    // RV64M
    def bitpat_MUL    = BitPat("b0000001 ????? ????? 000 ????? 01100 11")
    def bitpat_MULH   = BitPat("b0000001 ????? ????? 001 ????? 01100 11")
    def bitpat_MULHSU = BitPat("b0000001 ????? ????? 010 ????? 01100 11")
    def bitpat_MULHU  = BitPat("b0000001 ????? ????? 011 ????? 01100 11")
    def bitpat_DIV    = BitPat("b0000001 ????? ????? 100 ????? 01100 11")
    def bitpat_DIVU   = BitPat("b0000001 ????? ????? 101 ????? 01100 11")
    def bitpat_REM    = BitPat("b0000001 ????? ????? 110 ????? 01100 11")
    def bitpat_REMU   = BitPat("b0000001 ????? ????? 111 ????? 01100 11")
    def bitpat_MULW   = BitPat("b0000001 ????? ????? 000 ????? 01110 11")
    def bitpat_DIVW   = BitPat("b0000001 ????? ????? 100 ????? 01110 11")
    def bitpat_DIVUW  = BitPat("b0000001 ????? ????? 101 ????? 01110 11")
    def bitpat_REMW   = BitPat("b0000001 ????? ????? 110 ????? 01110 11")
    def bitpat_REMUW  = BitPat("b0000001 ????? ????? 111 ????? 01110 11")
