...
class NPC_IDU extends Module {
    ...
    idu_internal_io.idu_internal_exu_opcode_o := Lookup(idu_internal_io.idu_internal_inst_i, NPC_IDU_EX_Ops.EX_NOP, Array(
        ...
        NPC_IDU_Insts.SLL    -> NPC_IDU_EX_Ops.EX_SLL,
        NPC_IDU_Insts.SLT    -> NPC_IDU_EX_Ops.EX_SLT,
        NPC_IDU_Insts.SLTU   -> NPC_IDU_EX_Ops.EX_SLTU,
        NPC_IDU_Insts.XOR    -> NPC_IDU_EX_Ops.EX_XOR,
        NPC_IDU_Insts.SRL    -> NPC_IDU_EX_Ops.EX_SRL,
    ...
    idu_internal_io.idu_internal_exu_src1_o := Lookup(idu_internal_io.idu_internal_inst_i, 0.U(32.W), Array(
        ...
        NPC_IDU_Insts.ADD    -> IDU_RS1_Val,
        NPC_IDU_Insts.SUB    -> IDU_RS1_Val,
        NPC_IDU_Insts.SLL    -> IDU_RS1_Val,
        NPC_IDU_Insts.SLT    -> IDU_RS1_Val,
        NPC_IDU_Insts.SLTU   -> IDU_RS1_Val,
        NPC_IDU_Insts.XOR    -> IDU_RS1_Val,
        NPC_IDU_Insts.SRL    -> IDU_RS1_Val,
    ...
    idu_internal_io.idu_internal_exu_src2_o := Lookup(idu_internal_io.idu_internal_inst_i, 0.U(32.W), Array(
        ...
        NPC_IDU_Insts.ADD    -> IDU_RS2_Val,
        NPC_IDU_Insts.SUB    -> IDU_RS2_Val,
        NPC_IDU_Insts.SLL    -> (IDU_RS2_Val & "b11111".U),
        NPC_IDU_Insts.SLT    -> IDU_RS2_Val,
        NPC_IDU_Insts.SLTU   -> IDU_RS2_Val,
        NPC_IDU_Insts.XOR    -> IDU_RS2_Val,
        NPC_IDU_Insts.SRL    -> (IDU_RS2_Val & "b11111".U),
        NPC_IDU_Insts.SRA    -> (IDU_RS2_Val & "b11111".U),
        NPC_IDU_Insts.OR     -> IDU_RS2_Val,
        NPC_IDU_Insts.AND    -> IDU_RS2_Val,
